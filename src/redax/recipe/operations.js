...
export const fetchRecipe = createAsyncThunk("recipe/fetch", async ({ category, search }, thunkAPI) => {
    try {
...
export const fetchRecipeById = createAsyncThunk("recipe/fetchById", async (id) => {
    try {
